...
<body id="content">
  ...
  <div class="circleDesign cmsDesign">
  ...
  <section class="cmsSec py-5">
    <div class="circleBg3"><img src="assets/images/Ellipse2.png" alt="ellipse"></div>
    <div class="circleBg4"><img src="assets/images/Ellipse3.png" alt="ellipse"></div>
    <div class="circleBg5"><img src="assets/images/Ellipse4.png" alt="ellipse"></div>
    <div class="container">
      <div class="cmsSecText privacySec">
         <h1 >PRIVACY <span>POLICY</span></h1>
                <p><strong>Last updated January 01, 2025</strong></p>

                
                <p>This Privacy Notice for Drop It Inc ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:</p>
                <ul>
                    <li>Visit our website at <a href="http://www.showmobud.com">http://www.showmobud.com</a>, or any website of ours that links to this Privacy Notice</li>

                    <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                </ul>

                <p>Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:contact@showmobud.com">contact@showmobud.com.</a></p>

                <h3 class="section-title">SUMMARY OF KEY POINTS</h3>

                <p><i>This summary provides key points from our Privacy Notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our <a href="#toc">table of contents</a> below to find the section you are looking for.</i></p>

                <p>What personal information do we process? When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about <a href="#disclose-to-us">personal information you disclose to us.</a></p>
                ...
                <p>How do we process your information? We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. Learn more about <a href="#process">how we process your information</a>.</p>


                <p>In what situations and with which parties do we share personal information? We may share information in specific situations and with specific third parties. Learn more about <a href="#whanWhoom">when and with whom we share your personal information</a>.</p>


                <p>How do we keep your information safe? We have adequate organizational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about <a href="#safeInfo">how we keep your information safe</a>.</p>


                <p>What are your rights? Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn more about <a href="#privacyRights">your privacy rights.</a></p>


                <p>How do you exercise your rights? The easiest way to exercise your rights is by submitting a <a href="#">data subject access request</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>


                <p>Want to learn more about what we do with any information we collect? <a href="#review">Review the Privacy Notice in full</a>.</p>


                <h3 id="toc" class="section-title">Table of Contents</h3>
                 ...
                 <ul style="list-style-type: none; padding: 0;">
                    ...
                    <li><a href="#keepInfo">4. HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
                    <li><a href="#safeInfo">5. HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
                    ...
                    <li><a href="#specific">9. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
                    <li><a href="#updates">10. DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
                    <li><a href="#contact">11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
                    <li><a href="#review">12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
                </ul>

            <div id="information">
                <h2 class="section-title">1. WHAT INFORMATION DO WE COLLECT?</h2>
                <p id="disclose-to-us"><strong>Personal information you disclose to us</strong></p>
                ...
                <p><strong>Google API</strong>: Our use of information received from Google APIs will adhere to <a href="https://developers.google.com/terms/api-services-user-data-policy">Google API Services User Data Policy</a>, <a href="https://developers.google.com/terms/api-services-user-data-policy#limited-use"> including the Limited Use requirements.</a></p>
            </div>
            ...
            <div id="share">
                <h2 id="whanWhoom" class="section-title">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
                <p><i>In Short:</i> We may share information in specific situations described in this section and/or with the following third parties.</p>
            ...
            <div id="keepInfo">
                <h2 class="section-title">4. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
            ...
            <div id="safeInfo">
                <h2 class="section-title">5. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
            ...
            <div id="minors">
              ...
              <div id="privacyRights">
                ...
                <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:contact@showmobud.com">contact@showmobud.com.</a></p>
            </div>

            <div id="dnt">
                <h2 class="section-title">8. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
            ...
            <div id="usResidents">
                <h2 class="section-title">9. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
                ...
                <p>We may also collect other personal information outside of these categories through instances where you interact with us:</p>
                <ul>
                ...
                <h2 class="section-title">Sources of Personal Information</h2>
                <p>Learn more about the sources of personal information we collect in the section, <a href="#">"WHAT INFORMATION DO WE COLLECT?"</a></p>

                <h2 class="section-title">How We Use and Share Personal Information</h2> 
                <p>Learn more about how we use your personal information in the section, <a href="#process">"HOW DO WE PROCESS YOUR INFORMATION?"</a></p>

                <p>Will your information be shared with anyone else?</p>

                <p>We may disclose your personal information with our service providers pursuant to a written contract between us and each service provider. Learn more about how we disclose personal information to in the section,  <a href="#share">"WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?"</a></p>
                ...
                <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at <a href="mailto:contact@showmobud.com,"> contact@showmobud.com</a>, or by referring to the contact details at the bottom of this document.</p>

                <p>We will honor your opt-out preferences if you enact the <a href="https://globalprivacycontrol.org/">Global Privacy Control</a> (GPC) opt-out signal on your browser.</p>
                ...
                <h2 class="section-title">Request Verification</h2>
                ...
                <h2 class="section-title">Appeals</h2>
                ...
                <h2 class="section-title">California "Shine The Light" Law</h2>
            ...
            <div id="updates">
                <h2 class="section-title">10. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
            ...
            <div id="contact">
                  <h2 class="section-title">11. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                <p>If you have questions or comments about this notice, you may email us at <a href="mailto:contact@showmobud.com">contact@showmobud.com</a> or contact us by post at:</p>
            ...
            <div id="review">
                <h2 id="section-14" class="section-title">12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
                <p>You have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. You may also have the right to withdraw your consent to our processing of your personal information. These rights may be limited in some circumstances by applicable law. To request to review, update, or delete your personal information, please fill out and submit a <a href="https://app.termly.io/notify/3d1c9be3-fabc-4e3e-bc20-eef20499e018"> data subject access request.</a></p>
  ...
  <script type="text/javascript">
     $(document).ready(function () {
                      ...
                      // Smooth scrolling for links in Table of Contents
