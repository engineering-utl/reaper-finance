<?php include('header.php') ?>
    ...
    <section class="inner-banner" style="background: #6D7E7A;">
      <div class="bannerposter"><img  class="editable" id="cr_nft-img" contenteditable="true" src="<?php echo base_url('assets/images/NFTS.png')?>" alt=""></div>
    </section>
                ...
                <div class="col-md-6 mb-4">
                  <div class="card blog-card h-100">
                    ...
                    <div class="card-body bg-black text-white">
                      ...
                      <a href="<?= $nft['external_link'] ?>" class="text-danger fw-bold text-decoration-none" target = "_blank" ><i class="fas fa-arrow-right ms-1"></i></a>
                    </div>
                  </div>
                </div>
              <?php endforeach; ?>
